    ...
    <div className='maxContainer h-[100vh] flex flex-col justify-center '>
      <div className=' w-full max-h-[60rem] h-[100vh] flex justify-between items-center overflow-hidden'>
        <section className='auth-img lg:flex-1 w-[40%] md:block hidden h-full '>
          <div className='care w-full h-full p-[3rem] flex flex-col justify-center items-start lg:text-[3rem] text-[2rem] text-[#0DD983] font-semibold '>
            Syst
          </div>
        </section>
        <section className='flex-1 h-full bg-white '>
          <div className='lg:w-[70%] md:w-[90%] sm:w-[70%] xs:w-[90%] w-[95%] mx-auto h-full pr-[2rem] pl-[4rem] flex flex-col justify-center'>
            <h2 className='pb-[2rem] xl:text-[2rem] text-[1.5rem] sm:font-semibold font-bold'>Register on Syst</h2>
            <form onSubmit={handleSubmit} className='flex flex-col xl:gap-[1rem] gap-[0.5rem]'>
              ...
              <button className='w-full xl:py-[0.7rem] md:py-[0.5rem] py-[0.5rem] px-[1rem] lg:text-[1rem] sm:text-[0.9rem] text-[1rem] text-[#16CB7F] font-medium bg-[#0DD9834F] rounded-[2rem]'>Register</button>
            </form>
