                            ...
                            cartItems.map((item, index) => (
                                <tr key={index} className='xl:text-[1rem] text-[0.9rem] bg-white border-b-2 transition-all hover:scale-[1.02]'>
                                    ...
                                    <td className='text-center'>
                                        <svg onClick={() => removeItem()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="lg:size-5 size-4 text-[#F5222D]">
