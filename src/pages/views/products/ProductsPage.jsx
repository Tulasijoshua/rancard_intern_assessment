    ...
    <section className='maxSection w-full lg:px-[2rem] px-[1rem] sm:py-[3rem] py-[1.5rem]'>
      ...
      {cartItems.length > 0 ? (<>
        <div className='w-full py-[2rem] overflow-auto'>
                    <table className='min-w-[500px] w-full uncut-regular'>
                        <thead className='w-full xl:text-[1.1rem] text-[1rem] bg-[#EFEFEF]'>
                            <tr className=' text-left'>
                                ...
                                <th className='py-[0.8rem]'>Price</th>
            ...
            <div className='w-full py-[2rem] px-[2rem] bg-white'>
                {/* <Button  title="Export CSV" /> */}
                <CSVLink data={cartItems} className='px-[1rem] py-[0.5rem] bg-[#0DD983] text-white '>Export</CSVLink>
            </div>
        </div>
      </>) : (<>
        <div className='w-full flex flex-col justify-center items-center pt-[4rem]'><Empty text={'No history available'}/></div>
      </>)}
    </section>
  )
}
